...
class TrainerWithMeta(OnPolicyAlgorithm):
    ...
    def __init__(
        ...
        agents_env_fn = lambda: DummyGymEnv(self.agents_observation_space, self.agents_action_space)
    ...
    def logg(self, episode_logg: Dict):
        ...
        self.logger.record("meta/timeout_time", safe_mean([ep_info["timeout_time"] for ep_info in self.ep_info_buffer]))
