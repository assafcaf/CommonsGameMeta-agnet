...
from marl.independent_ppo import IndependentPPO
...
def main(args):
    ...
    # Training
    num_cpus = 32  # number of cpus
    num_envs = 4  # number of parallel multi-agent environments
    num_frames = 2  # number of frames to stack together; use >4 to avoid automatic VecTransposeImage
    features_dim = (
